...
abstract class AbstractConditions extends \Phalcon\DataMapper\Query\AbstractQuery
{
     ...
     * @return void
     */
    protected function addCondition(string $store, string $andor, string $condition, $value = null, int $type = -1)
    {
    }
     ...
     * @return void
     */
    protected function appendCondition(string $store, string $condition, $value = null, int $type = -1)
    {
    }
     ...
     * @return void
     */
    protected function processValue(string $store, $data)
    {
    }
}
