...
abstract class AbstractConnection implements \Phalcon\DataMapper\Pdo\Connection\ConnectionInterface
{
     ...
     */
    public function prepare(string $statement, array $options = array())
    {
    }
     ...
     * @return array
     */
    protected function fetchData(string $method, array $arguments, string $statement, array $values = array()): array
    {
    }
}
