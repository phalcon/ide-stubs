...
class Select extends AbstractList
{
     ...
     * @return Select
     */
    public function add(string $text, string $value = null, array $attributes = array(), bool $raw = false): Select
    {
    }
     ...
     * @return Select
     */
    public function addPlaceholder(string $text, $value = null, array $attributes = array(), bool $raw = false): Select
    {
    }
     ...
     * @return Select
     */
    public function optGroup(string $label = null, array $attributes = array()): Select
    {
    }
